...
class FlappyBird(base.PyGameWrapper):
    ...
    def getGameState(self):
        ...
        state = {
            ...
            "player2_next_pipe_top_y": next_pipe2.gap_start,
            "player2_next_pipe_bottom_y": next_pipe2.gap_start + self.pipe_gap,
            "next_next_pipe_dist_to_player2": next_next_pipe2.x + next_next_pipe2.width/2 - self.player[2].pos_x ,
            "player2_next_next_pipe_top_y": next_next_pipe2.gap_start,
            "player2_next_next_pipe_bottom_y": next_next_pipe2.gap_start + self.pipe_gap
        }
